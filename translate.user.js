...
(function () {
    ...
    class Translate {
        ...
        modalVisible() {
            ...
            let a = ` <div id='ZTYmodalZTY' style="position: fixed;top:${y}px; left: ${x}px;">`;
            let modal = a + `
        ...
        whenSuccess(data, e) {
            ...
            let b = `   <div id='ZTYcontentZTY' style='border:1px solid ;border-radius: 10px ;padding:5px 15px;background: #FFF;height:30px;position: fixed;top:${y}px ;left:${x}px'>`;
            let content = b + `
